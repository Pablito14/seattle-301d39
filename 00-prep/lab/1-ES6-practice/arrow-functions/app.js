...
// this refers to the Student object instance that is Joe

// 2. What is "this" when joe.scopeArrow() is invoked?
// the this in the context of the arrrow function refers to the window object since it bubbles up to the next scope.

// 3. Explain why "this" is different when an arrow function is used.
// I do not know why it is different, I only know what the differences are and that they are there.
